...
export default function BaseDigitalPage() {
  return (
    <div className="w-full overflow-x-clip text-[#E2E8F0]">
      ...
      {/* ── PIEZA 01: CONTEXTO ESTABLE ── Full-width video section ── */}
      <StickyScrollVideoSection src="/videos/video-base.mp4">
        ...
        <p className="text-lg sm:text-xl text-gray-100 leading-relaxed font-normal max-w-3xl">
      ...
      {/* ── PIEZA 02: DATOS VIVOS ── Full-width video section ── */}
      ...
      {/* ── PIEZA 03: HERRAMIENTAS CONECTADAS ── Full-width video section ── */}
