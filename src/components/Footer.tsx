    ...
    <footer className="bg-[#05070A] border-t border-surface-border py-16 text-gray-300">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 border-b border-surface-border/60 pb-12">
          ...
          <Link
            href="/agendar"
            className="inline-flex items-center gap-2.5 px-6 py-3 rounded-lg text-base font-normal text-white bg-[#0A3D62] hover:bg-[#009DF8] hover:shadow-[0_0_35px_rgba(0,157,248,1)] hover:scale-[1.03] transition-all duration-300 shrink-0"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-sm">
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/diagnostico" className="text-gray-300 hover:text-white transition-colors">Diagnóstico 360 €</Link></li>
            </ul>
          </div>
