# PROYECTO — Web corporativa iARTESANA · v4

> Reestructuración del sitio: de agencia de comunicación a implantación de IA por capas.
> Documento de arquitectura y decisiones. **No es aún el prompt de construcción**: ese se escribe cuando se cierren las decisiones de la sección 14.
...
5. **Preparación normativa.** Qué hay que tener ordenado para llegar a tiempo.
...
1. **¿A qué tamaño de empresa se escribe primero?** No se redacta igual para cinco personas que para cien.
2. **¿Cuál es el resultado principal que se promete?** Ahorro de tiempo, mejor atención, orden interno, control de información o capacidad de escalar. Elegir uno como dominante.
...
5. **¿Dónde termina iARTESANA y empieza el asesor legal o de protección de datos?**
6. **¿Qué control conserva el cliente sobre código, datos, cuentas y proveedores?** Define lo que se puede prometer en `/seguridad-control`.
7. **¿Cuál será el primer caso demostrable?** Sin caso concreto, la web será pedagógicamente buena y comercialmente abstracta. ¿Es 3villas citable, aunque sea sin nombre?
8. **¿Precios de las capas siguientes:** horquillas orientativas o nada?
9. **¿Quién valida las afirmaciones legales** de `/seguridad-control` antes de publicar?
10. **¿La accesibilidad se convierte en línea de servicio?** Existe normativa europea de accesibilidad ya aplicable a determinados productos y servicios digitales, con exenciones según tamaño de empresa y sector. Si afecta a vuestro tipo de cliente, es un servicio vendible que encaja en `/seguridad-control` y que casi nadie está ofreciendo a pymes. **Requiere verificación previa de alcance y exenciones** antes de mencionarlo en la web (misma disciplina que el resto de afirmaciones normativas). Decidir si se investiga ahora o queda para fase 4.
11. **Teléfono:** sigue sin resolver el 684 vs 683 del manual de marca.
12. **Idiomas:** ¿castellano solo, o catalán e inglés desde el inicio? Afecta a la arquitectura de rutas; no se improvisa después.

---

## 15. Fases

**Fase 0 — Decisiones (esta semana).** Cerrar la sección 14. Sin esto, todo lo demás se hace dos veces.
